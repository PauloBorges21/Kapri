        ...
        <div class="intro-container">
            <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active" style="background-image: url('img/intro-carousel/japonesa.jpeg');">
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2>We are professional</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                <a href="#featured-services" class="btn-get-started scrollto">Diferenciais</a>
                            </div>
                        </div>
                    </div>

                    <div class="carousel-item" style="background-image: url('img/intro-carousel/blue-eyes-woman-female-makeup-60894.jpeg');">
                        <div class="carousel-container">
                            <div class="carousel-content">
                    ...
                    <div class="carousel-item" style="background-image: url('img/intro-carousel/pexels-photo-906052.jpeg');">
                        <div class="carousel-container">
                            <div class="carousel-content">
                    ...
                    <div class="carousel-item" style="background-image: url('img/intro-carousel/makeup-retouch-glamour-model-111137.jpeg');">
                        <div class="carousel-container">
                            <div class="carousel-content">
                    ...
                    <div class="carousel-item" style="background-image: url('img/intro-carousel/pexels-photo-971493.jpeg');">
                        <div class="carousel-container">
                            <div class="carousel-content">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 box">
                        ...
                        <h4 class="title"><a href="">Ótima Localização</a></h4>
                ...
                <div class="skills-content">
                    ...
                    <div class="progress">
                        <div class="progress-bar bg-success" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                            <span class="skill">HTML <i class="val">25%</i></span>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="owl-carousel testimonials-carousel">
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="fb-post" data-href="https://www.facebook.com/catia.armigliatto/posts/10155425831297407" data-width="500" data-show-text="true">
                            <a href="https://www.facebook.com/catia.armigliatto" target="_blank">
                                <h3>Catia Armigliatto</h3>
                            </a>
                            <blockquote cite="https://www.facebook.com/catia.armigliatto/posts/10155425831297407">
                                <p>Lugar lindo!!!! Atendimento excelente, e tem todos procedimentos maravilhosos!!!! amei e super recomendo❤</p>Publicado por <a href="https://www.facebook.com/catia.armigliatto" target="_blank">Catia Armigliatto</a> em&nbsp;<a href="https://www.facebook.com/catia.armigliatto/posts/10155425831297407">Quinta-feira, 16 de agosto de 2018</a>
                            </blockquote>
                        </div>
                    ...
                    <div class="testimonial-item">
                        ...
                        <iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fcatia.armigliatto%2Fposts%2F10155425831297407&width=500" width="500" height="161" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
                    </div>
...
-->
                    ...
                    <form action="enviar.php" method="post" enctype="multipart/form-data" name="form" class="formphp" id="formlimpa">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control" name="telefone" maxlength="15" id="telefone" placeholder="Telefone" onfocus out="return validaCel()" />
            ...
            <div class="form-group col-md-6">
              ...
              <div class="validation"></div>
                    ...
                    <script>
                        //chamada AJAX pra enviar o email de boas-vindas e salvar no banco o contato
                        $("#enviar").click(function(){
                            ...
                            if((nome != '' || nome == null) && (telefone != '' || telefone == null) && (email != '' || email == null) && (assunto != '' || assunto == null) && (mensagem != '' || mensagem == null)){

                                $("#enviar").hide();
                                $("#processando").show();
                                $("#processando").html('<img src="img/loading.svg" width="50" />');
